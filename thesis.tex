...
is considered background. The posterior probability is calculated with the Bayesian theorem as follows:
...
methods are described in Sec.~\ref{subsubsec:features}. No contrast enhancement was used, so raw color info
