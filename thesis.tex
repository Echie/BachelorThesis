...
a slighty higher overall performance of GMM-Bayes classifiers can be seen. The Naive-Bayes edge-classifier is an exception,
clearly outperforming any other single-feature trained classifier or even the classifier with all features included.
...
variation in the training set, but this was not confirmed.
