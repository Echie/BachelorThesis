...
a slighty higher overall performance
of GMM-Bayes classifiers can be seen. The Naive-Bayes edge-classifier is an exception, clearly outperforming any other
single-feature trained classifier or even the classifier with all features included. Based on the specificity of the texture-based
classifiers, their performance was below the others. The image-specific results explain this, as the texture-based classifier behaves
similarly to a random classifier. This could be because of the feature's variation in the training set, but this was not confirmed.
...
\begin{figure}[ht]
{
  ...
  \subref{fig:bayes_spec} Specificity }
  \label{fig:bayes}
...
\begin{figure}[ht]
{
  ...
  \subref{fig:gmmbayes_spec} Specificity }
  \label{fig:gmmbayes}
