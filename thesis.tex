...
The human eye is capable of correcting the effect of varying light sources (illuminants) in perception of color~\cite{Foster:2011}. This is why
...
\subsubsection{Bayesian classification using Gaussian Mixture Models}
...
classifies the sample to the class with the highest posterior probability.
In the case of binary pixel classification, classes are foreground and background. In this thesis, exudates represent the foreground and the rest 
