...
Sensitivity represents the amount of samples correctly classified as positive, and specificity in turn represents the amount correctly classified as negative.
They are defined as~\cite{Fawcett:2006}:
% \vspace{-1mm}
...
Comparing the sensitivity and specificity of Naive-Bayes and GMM-Bayes classifiers, a slighty higher overall performance
of GMM-Bayes classifiers can be seen. The Naive-Bayes edge-classifier is an exception, clearly outperforming any other
single-feature trained classifier or even the classifier with all features included.
