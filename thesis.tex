...
readily available and includes accurate ground truth information. To enable comparison between image features, colour, edge and
...
a slighty higher performance of colour-feature GMM-Bayes classifiers can be seen. The Naïve-Bayes edge-classifier on the other hand,
