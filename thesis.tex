...
\begin{figure}[ht]
{
  \subfloat[]{
     \label{fig:sens}
     \includegraphics[width=1\textwidth]{hist_bayes_sens_imgset1}}
  
  \subfloat[]{
     \label{fig:spec}
     \includegraphics[width=1\textwidth]{hist_bayes_spec_imgset1}}
     
  \caption[moving]{Performance of Naive-Bayes classifiers:
  \subref{fig:sens} Sensitivity
  \subref{fig:spec} Specificity }
  \label{fig:bayes}
...
\begin{figure}[ht]
{
  \subfloat[]{
     \label{fig:unsupsens}
     \includegraphics[width=1\textwidth]{hist_unsup_sens_imgset1}}

  \subfloat[]{
     \label{fig:unsupspec}
     \includegraphics[width=1\textwidth]{hist_unsup_spec_imgset1}}
